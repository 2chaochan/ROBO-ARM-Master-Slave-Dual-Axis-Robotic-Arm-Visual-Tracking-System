...
如果后续你准备把这个仓库长期维护下去，建议继续补充：

- `openmv/`：视觉识别脚本
- `docs/`：赛题书、项目书、论文与实物照片
- `hardware/`：原理图、接线图、BOM

## 说明

`archive/` 目录下保留的是当前工作区里已有的历史材料，其中部分内容与本赛题并不完全对应，仅作为归档保留，不建议作为本项目的正式技术文档使用。
