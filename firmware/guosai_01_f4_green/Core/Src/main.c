...
//      delay_ms(500);
//			HAL_GPIO_WritePin(GPIOG , GPIO_PIN_1 , GPIO_PIN_RESET); //·äÃùÆ÷¼ä¶ÏÏì
//      delay_ms(500);
//      HAL_GPIO_WritePin(GPIOG , GPIO_PIN_1 , GPIO_PIN_SET); 
//      delay_ms(500);
//			HAL_GPIO_WritePin(GPIOG , GPIO_PIN_1 , GPIO_PIN_RESET); //·äÃùÆ÷¼ä¶ÏÏì
//			
		...
		if(HAL_GPIO_ReadPin(GPIOF,GPIO_PIN_1)==GPIO_PIN_RESET)//Ñ¡Ôñ×óÓÒ£¬Ä¬ÈÏ×ó±ß
		{
//		__HAL_TIM_SetCompare(&htim3, TIM_CHANNEL_1,2000);ÐÞ¸Ä
